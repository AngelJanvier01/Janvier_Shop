...
- [x] `npm run check`: TypeScript, ESLint, Prettier y 173 pruebas unitarias.
...
- [ ] Activar en Cloudflare la redirección HTTP→HTTPS y redirigir `www` al dominio
      canónico conservando ruta y query. El 21 de septiembre de 2026 ambos respondían 200.
...
- [ ] Confirmar que el dominio sirve la revisión actual. El 21 de septiembre de 2026 el
      despliegue activo todavía devolvía 404 para manifest e imagen Open Graph.
...
- [Despliegue reproducible](docs/PRODUCTION_DEPLOYMENT.md)
- [Validación posterior al despliegue](docs/POST_DEPLOY_VALIDATION.md)
